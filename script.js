...
const playAudioOnInteraction = () => {
    if (!audioPlayed) {
        ...
        // Remove all listeners once audio logic triggers to save processing power
...
// Android relies heavily on explicit touch/click to unlock audio. Scroll works on iOS.
['click', 'scroll', 'touchstart', 'touchend'].forEach(evt => {
...
window.addEventListener('scroll', () => {
    ...
    if (p < 0.15) {
        ...
        // PHASE 1: Greeting & scroll indicator cleanly fade out. Image Zooms fast to Groom.
